...
# Bot Admins
ADMINS = environ.get('ADMINS', '5898522531')
if len(ADMINS) == 0:
...
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/freestoryhubmr')
...
STICKERS = [sticker for sticker in environ.get('STICKERS', 'CAACAgUAAxkBAAIIQGmoYRbKhG6X5sWm67hkwikuoWPQAALWCgACgCqoVbpYfx3qNQlCHgQ').split()]  # Multiple sticker can be used separated by space, use @idstickerbot for get sticker id
...
UPI_NAME = environ.get("UPI_NAME", "Anubhav_Kumar") # add your UPI account name
if len(UPI_NAME) == 0:
    logger.info('UPI_NAME is empty')
RECEIPT_SEND_USERNAME = environ.get("RECEIPT_SEND_USERNAME", "@O_Deleted_Account_0")
